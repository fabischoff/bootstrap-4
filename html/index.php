                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="#" class="dropdow-item">Paisagem</a></li>
                                <li><a href="#" class="dropdow-item">Tecnologia</a></li>
                                <li><a href="#" class="dropdow-item">Abstrato</a></li>
                                <li class="dropdown-divider"></li>
                                <li><a href="#" class="dropdow-item">Animais</a></li>
                                <li><a href="#" class="dropdow-item">Comida</a></li>
                                <li><a href="#" class="dropdow-item">Pessoas</a></li>
                            </ul>
                        </li>
